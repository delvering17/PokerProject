...
public class FindIDPW_panel extends JPanel{
	...
	public FindIDPW_panel(Login_frame login_frame,Receiver ch) {
		...
		name_find = new Gen_textfiled(login_frame,"이름","Login_textfiled_id",500,150, 200,50);
 		...
 		// 확인 버튼
 		add(new Gen_button_login(login_frame,"아이디 찾기","FindID_button",500,250, 100,50,ch));
		...
		// 확인 버튼
		add(new Gen_button_login(login_frame,"비밀번호 찾기","FindPW_button",500,500, 100,50,ch));
